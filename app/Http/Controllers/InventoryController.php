    ...
    public function getData()
    {
        ...
        return DataTables::of($inventories)
            ...
            ->addColumn('action', function ($inventory) {
                return '
                    <button onclick="editInventory('.$inventory->id.')" class="px-3 py-1 text-xs text-white bg-blue-500 rounded hover:bg-blue-600">Edit</button>
                    <button onclick="deleteInventory('.$inventory->id.')" class="px-3 py-1 text-xs text-white bg-red-500 rounded hover:bg-red-600">Hapus</button>
                ';
            })
