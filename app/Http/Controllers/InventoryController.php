        ...
        return DataTables::of($inventories)
            ...
            ->addColumn("action", function ($inventory) {
                ...
                <div class="flex gap-2">
                    ...
                    $inventory->id .
                    ')" class="px-3 py-1.5 text-xs text-black bg-blue-500 rounded-lg hover:bg-blue-600 transition shadow-sm flex items-center gap-1">
                    ...
                    $inventory->id .
                    ')" class="px-3 py-1.5 text-xs text-black bg-red-500 rounded-lg hover:bg-red-600 transition shadow-sm flex items-center gap-1">
                        <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20">
