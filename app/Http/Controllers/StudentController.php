            ...
            ->addColumn('action', function ($student) {
                return '
                    <div class="flex gap-2">
                        <button onclick="editStudent('.$student->id.')" class="px-3 py-1.5 text-xs text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition shadow-md flex items-center gap-1 font-medium">
                            <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z"/>
                            </svg>
                            Edit
                        </button>
                        <button onclick="deleteStudent('.$student->id.')" class="px-3 py-1.5 text-xs text-white bg-red-600 rounded-lg hover:bg-red-700 transition shadow-md flex items-center gap-1 font-medium">
                            <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20">
