        ...
        <div class="w-full max-w-md">
            ...
            <div class="glass-effect rounded-2xl shadow-2xl p-8">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-5">
                    ...
                    <!-- Login Button -->
                    <x-btn variant="primary" type="submit" class="w-full justify-center py-3 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all">
            ...
            <div class="text-center mt-6">
                <p class="text-indigo-100 text-sm">© 2025 School Management System. All rights reserved.</p>
            </div>
        </div>
    </div>
</x-guest-layout>